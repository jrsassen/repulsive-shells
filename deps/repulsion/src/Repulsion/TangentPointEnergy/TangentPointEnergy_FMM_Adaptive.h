...
#define CLASS TangentPointEnergy_FMM_Adaptive
...
namespace Repulsion
{
    ...
    public:
        ...
        CLASS(
            ...
            const AdaptivitySettings & set_ = AdaptivityDefaultSettings
        )
        :   BASE(
            *Make_TangentPointEnergy_NearFieldKernel          <DOM_DIM,DOM_DIM,AMB_DIM,Real,Int,SReal> (alpha_,beta_),
            *Make_TangentPointEnergy_NearFieldKernel_Adaptive <DOM_DIM,DOM_DIM,AMB_DIM,Real,Int,SReal> (alpha_,beta_,set_),
            *Make_TangentPointEnergy_FarFieldKernel_FMM       <AMB_DIM,DEGREE,Real,Int>
                (alpha_,beta_),
            weight
            )
        ,   alpha(alpha_)
