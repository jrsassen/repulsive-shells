...
#define CLASS TangentPointObstacleEnergy_FMM_Adaptive
...
namespace Repulsion
{
    ...
    public:
        ...
        :   BASE(
            *Make_TangentPointEnergy_NearFieldKernel<DOM_DIM1,DOM_DIM2,AMB_DIM,Real,Int,SReal>( alpha_, beta_ ),
            *Make_TangentPointEnergy_NearFieldKernel_Adaptive<DOM_DIM1,DOM_DIM2,AMB_DIM,Real,Int,SReal>( alpha_, beta_, settings_),
